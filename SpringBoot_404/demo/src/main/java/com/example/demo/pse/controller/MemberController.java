...
public class MemberController {
    ...
    // 회원 정보 업데이트 폼 보여주기
    @GetMapping("/update")
    public String showUpdateForm(Model model, @RequestParam("email") String email) {
    ...
    // 회원 정보 업데이트 처리
    @PostMapping("/update")
    public String processUpdate(@RequestParam("email") String email, @ModelAttribute MemberDTO memberDTO) {
